...
class AssetModel(BaseDataModel):
    ...
    async def get_asset_record(self , asset_prject_id:str , asset_name:str):
        record = await self.collection.find_one({
            "asset_project_id": ObjectId(asset_prject_id) if isinstance(asset_prject_id, str) else asset_prject_id,
